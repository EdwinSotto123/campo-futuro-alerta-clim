...
import { UbicacionGeodata } from '@/pages/MiGranjaVirtual';
    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        ...
        try {
          ...
          console.error('Error al procesar la ubicación detectada:', error);          // Añadir marcador aunque falle la geocodificación
                ...
                <Card>
                  <CardHeader className="pb-3">
                    ...
                    <div>
                      ...
                      <Badge variant="secondary">{selectedLocation.country}</Badge>
                    </div>
                    ...
                    {selectedLocation.altitude !== undefined && (
                      <div>
                        <p className="text-sm font-medium">Altitud:</p>
                        <Badge variant="outline">{selectedLocation.altitude} m.s.n.m.</Badge>
                      </div>
                    )}
                  </CardContent>
                </Card>
