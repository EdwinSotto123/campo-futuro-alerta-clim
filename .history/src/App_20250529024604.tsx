...
import GranjaVirtualPage from "@/pages/GranjaVirtualPage";
    ...
    <BrowserRouter>
      <TooltipProvider>
        <Routes>
          ...
          <Route path="/aprendiendo" element={<AppLayout><AprendiendoPage /></AppLayout>} />
          ...
          <Route path="/granja" element={<AppLayout><GranjaVirtualPage /></AppLayout>} />
