...
const AITechnologySection = () => {
  ...
  const techStack = [
    ...
    { name: "TensorFlow", icon: "🧠", desc: "Machine Learning", highlight: false },
    { name: "Python AI", icon: "🐍", desc: "Análisis de Datos", highlight: false },
    { name: "NASA APIs", icon: "🛰️", desc: "Datos Satelitales", highlight: false },
    { name: "Google Earth", icon: "🌍", desc: "Geolocalización", highlight: false },
    { name: "OpenAI", icon: "⚡", desc: "Procesamiento NLP", highlight: false }
  ];
