...
const FeaturesSection = () => {  const mainFeatures = [
    ...
    },
    {
      ...
      details: ["Watson NLU multiidioma", "Aprendizaje continuo", "Escalamiento inteligente"],
      color: "text-blue-600",
      bgColor: "bg-blue-50",
      aiPowered: true
    },
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-white via-purple-50/20 to-blue-50/30">
