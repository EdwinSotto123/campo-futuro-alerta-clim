...
const MiGranjaVirtual: React.FC = () => {
  ...
  const obtenerEstiloCelda = (celda: CeldaGranja) => {
    const estilosBase = "w-full h-32 border-4 rounded-2xl cursor-pointer flex flex-col items-center justify-center text-center p-2 relative overflow-hidden backdrop-blur-md group transition-all duration-300 hover:scale-105";
    
    switch (celda.tipo) {
      case 'cultivo':
        return {
          className: `${estilosBase} bg-gradient-to-br from-emerald-400 via-green-500 to-lime-600 border-green-300 shadow-lg hover:shadow-2xl`,
          emoji: celda.datos ? obtenerEmojiCultivo(celda.datos.tipo) : '🌱',
          texto: celda.datos ? celda.datos.nombre : 'Cultivo',
          subtexto: celda.datos ? `${celda.datos.area}ha` : 'Agregar cultivo'
        };
      
      case 'proveedor':
        return {
          className: `${estilosBase} bg-gradient-to-br from-cyan-400 via-blue-500 to-indigo-600 border-blue-300 shadow-lg hover:shadow-2xl`,
          emoji: celda.datos ? obtenerEmojiProveedor(celda.datos.tipo) : '🏪',
          texto: celda.datos ? celda.datos.nombre : 'Proveedor',
          subtexto: celda.datos ? celda.datos.tipo : 'Agregar proveedor'
        };
      
      case 'cliente':
        return {
          className: `${estilosBase} bg-gradient-to-br from-fuchsia-400 via-purple-500 to-violet-600 border-purple-300 shadow-lg hover:shadow-2xl`,
          emoji: celda.datos ? obtenerEmojiCliente(celda.datos.tipo) : '👥',
          texto: celda.datos ? celda.datos.nombre : 'Cliente',
          subtexto: celda.datos ? celda.datos.tipo : 'Agregar cliente'
        };

      case 'trabajador':
        return {
          className: `${estilosBase} bg-gradient-to-br from-orange-400 via-red-500 to-pink-600 border-red-300 shadow-lg hover:shadow-2xl`,
          emoji: celda.datos ? obtenerEmojiTrabajador(celda.datos.rol) : '👨‍🌾',
          texto: celda.datos ? `${celda.datos.nombre} ${celda.datos.apellidos}` : 'Trabajador',
          subtexto: celda.datos ? celda.datos.rol : 'Agregar trabajador'
        };
      
      case 'almacen':
        return {
          className: `${estilosBase} bg-gradient-to-br from-yellow-400 via-amber-500 to-orange-600 border-yellow-300 shadow-lg hover:shadow-2xl`,
          emoji: celda.datos ? obtenerEmojiAlmacen(celda.datos.tipo) : '🏭',
          texto: celda.datos ? celda.datos.nombre : 'Almacén',
          subtexto: celda.datos ? `${celda.datos.capacidad_usada}/${celda.datos.capacidad_total}t` : 'Agregar almacén'
        };

      case 'reservorio':
        return {
          className: `${estilosBase} bg-gradient-to-br from-sky-400 via-cyan-500 to-blue-600 border-cyan-300 shadow-lg hover:shadow-2xl`,
          emoji: celda.datos ? obtenerEmojiReservorio(celda.datos.tipo) : '💧',
          texto: celda.datos ? celda.datos.nombre : 'Reservorio',
          subtexto: celda.datos ? `${celda.datos.nivel_actual}%` : 'Agregar reservorio'
        };
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {vistaActual === 'granja' && (
          <div className="space-y-6">
            ...
            {/* Grid Principal de la Granja - Ahora ocupa todo el ancho */}
            <Card className="shadow-xl">
              ...
              <CardContent className="p-6 bg-gradient-to-br from-emerald-50 via-green-50 to-lime-50 rounded-lg relative min-h-[600px]">
                ...
                {/* Grid de la granja con más espacio */}
                <div 
                  className="grid gap-6 auto-rows-fr p-8 bg-gradient-to-br from-white/30 via-emerald-50/40 to-lime-50/30 backdrop-blur-xl rounded-3xl border-2 border-white/40 shadow-2xl relative overflow-hidden"
                    ...
                    return (
                      <div
                        ...
                        className={`${estilo.className} ${
                          celdaSeleccionada?.id === celda.id ? 'ring-4 ring-yellow-400 ring-opacity-75 scale-105' : ''
                        }`}
                        style={{ 
                      ...
                      >
                        {/* Emoji más grande */}
                        <div className="text-5xl mb-3 drop-shadow-2xl">{estilo.emoji}</div>
                        
                        {/* Texto principal */}
                        <div className="text-sm font-black text-white drop-shadow-lg">{estilo.texto}</div>
                        ...
                        {celda.tipo !== 'vacio' && (
                          <>
                            <div className="absolute top-2 right-2 w-5 h-5 bg-emerald-400 rounded-full shadow-lg"></div>
                            <div className="absolute top-2 right-2 w-5 h-5 bg-emerald-300 rounded-full"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  value={formData.marcaFertilizante || ''}                  onChange={(e) => setFormData({ ...formData, marcaFertilizante: e.target.value })}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                type="number"
                min="0"
                value={formData.altitud || ''}                onChange={(e) => setFormData({ ...formData, altitud: parseInt(e.target.value) })}              placeholder="Ej: 3200 metros sobre el nivel del mar"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  type="number"
                  min="0"
                  value={formData.rendimientoEstimado || ''}                  onChange={(e) => setFormData({ ...formData, rendimientoEstimado: parseFloat(e.target.value) })}
              ...
              <div>
                ...
                <Input
                  ...
                  type="number"
                  min="0"
                  value={formData.costoInversion || ''}                  onChange={(e) => setFormData({ ...formData, costoInversion: parseFloat(e.target.value) })}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  type="number"
                  min="0"
                  value={formData.distancia_capital_km || ''}                  onChange={(e) => setFormData({ ...formData, distancia_capital_km: parseInt(e.target.value) })}
                  placeholder="Ej: 25"
                  className="border-blue-200 focus:border-blue-400"
                />
              </div>
            ...
            <div>
              ...
              <Input
                ...
                value={formData.carreteras_principales || ''}                onChange={(e) => setFormData({ ...formData, carreteras_principales: e.target.value.split(',').map(s => s.trim()) })}
            ...
            <div>
              ...
              <Input
                ...
                value={formData.caracteristicas_geograficas || ''}                onChange={(e) => setFormData({ ...formData, caracteristicas_geograficas: e.target.value.split(',').map(s => s.trim()) })}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  type="number"
                  min="0"
                  value={formData.capacidad_carga_kg || ''}                  onChange={(e) => setFormData({ ...formData, capacidad_carga_kg: parseInt(e.target.value) })}
                  placeholder="Ej: 2000"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  type="number"
                  min="0"
                  value={formData.costos_transporte_mes || ''}                  onChange={(e) => setFormData({ ...formData, costos_transporte_mes: parseInt(e.target.value) })}
                  placeholder="Ej: 800"
                  className="border-indigo-200 focus:border-indigo-400"
                />
              </div>
            ...
            <div>
              ...
              <Input
                ...
                value={formData.vehiculos_disponibles || ''}                onChange={(e) => setFormData({ ...formData, vehiculos_disponibles: e.target.value.split(',').map(s => s.trim()) })}
            ...
            <div>
              ...
              <Input
                id="rutas_criticas"
                value={formData.rutas_criticas || ''}                onChange={(e) => setFormData({ ...formData, rutas_criticas: e.target.value.split(',').map(s => s.trim()) })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  value={formData.backup_transporte || ''}                  onChange={(e) => setFormData({ ...formData, backup_transporte: e.target.value })}
              ...
              <div>
                ...
                <Input
                  id="mercados_destino"
                  value={formData.mercados_destino || ''}                  onChange={(e) => setFormData({ ...formData, mercados_destino: e.target.value.split(',').map(s => s.trim()) })}
            ...
            <div>
              ...
              <Textarea
                ...
                value={formData.dependencias_criticas || ''}                onChange={(e) => setFormData({ ...formData, dependencias_criticas: e.target.value.split(',').map(s => s.trim()) })}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    min="18"
                    max="70"
                    value={formData.edad || ''}                    onChange={(e) => setFormData({ ...formData, edad: parseInt(e.target.value) })}                    placeholder="Ej: 35"
                    className="border-green-300 focus:border-green-500 bg-white"
                  />
                </div>
              </div>
      ...
      case 2:
        return (
          <div className="space-y-6">
            ...
            {/* MapSelector para ubicación del trabajador */}
            <MapSelector
        ...
        return (
          <div className="space-y-6 p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg border border-green-200">
            <div className="text-center mb-4">
              ...
              </div>              <h3 className="text-xl font-bold text-green-800 mb-2">
                Paso 2: Ubicación y Accesibilidad 🗺️
              </h3>
              <p className="text-green-600 text-sm">Localización geográfica y datos logísticos</p>
            </div>

            {/* MapSelector para ubicación del cliente inteligente */}
            <MapSelector
              onLocationSelect={(locationData) => {
                setFormData({ 
                  ...formData, 
                  ubicacion: locationData.location,
                  direccion_completa: `${locationData.location.distrito}, ${locationData.location.provincia}, ${locationData.location.departamento}`,
                  coordenadas: locationData.coordinates
                });
              }}
              selectedLocation={formData.ubicacion}
