      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {vistaActual === 'granja' && (
          <ResizablePanelGroup direction="horizontal" className="h-[600px] rounded-lg border">
                ...
                <CardHeader>
                  ...
                  >
                      ...
                      return (
                        <div
                          key={celda.id}
                          className={`${estilo.className} group relative cursor-pointer`}
            ...
            <ResizablePanel defaultSize={30} minSize={25}>              <Card className="h-full bg-gray-50 border border-gray-200 shadow-md relative overflow-hidden">
                ...
                <CardContent className="h-[calc(100%-100px)] overflow-auto space-y-5 p-6 relative">
                  ...
                  <div className="space-y-5">                    {/* Cultivos */}
                    <div className="bg-green-50 border-green-200 border-2 p-5 rounded-lg shadow-md">
                    ...
                    <div className="bg-blue-50 border-blue-200 border-2 p-5 rounded-lg shadow-md">
                      <div className="flex justify-between items-center">
                    ...
                    <div className="bg-purple-50 border-purple-200 border-2 p-5 rounded-lg shadow-md">
                      <div className="flex justify-between items-center">
                    ...
                    <div className="bg-orange-50 border-orange-200 border-2 p-5 rounded-lg shadow-md">
                      <div className="flex justify-between items-center">
                    ...
                    <div className="bg-yellow-50 border-yellow-200 border-2 p-5 rounded-lg shadow-md">
                      <div className="flex justify-between items-center">
                    ...
                    <div className="bg-cyan-50 border-cyan-200 border-2 p-5 rounded-lg shadow-md">
                      <div className="flex justify-between items-center">
                    ...
                    <div className="bg-gray-50 border-gray-200 border-2 p-5 rounded-lg shadow-md">
                      <div className="flex justify-between items-center">
                  ...
                  {/* Acciones Rápidas Súper Mejoradas */}                  <div className="border-t-4 border-green-500 pt-6 mt-6 relative">
                    ...
                    <div className="space-y-4 mt-4">
                      <Button 
                        size="lg" 
                        className="w-full justify-start text-sm bg-indigo-500 hover:bg-indigo-600 text-white font-medium py-3 px-4 rounded-lg shadow"
                        onClick={() => setVistaActual('estadisticas')}                      >
                      ...
                      <Button 
                        size="lg" 
                        className="w-full justify-start text-sm bg-green-500 hover:bg-green-600 text-white font-medium py-3 px-4 rounded-lg shadow"
                        onClick={() => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-3">
          {[1, 2, 3, 4].map((paso, index) => (            <React.Fragment key={paso}>              <div                className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${
                  paso === pasoActual
...
const FormularioClienteInteligente: React.FC<{ formData: any; setFormData: (data: any) => void; ubicacionesExistentes: UbicacionGeodata[] }> = ({ formData, setFormData, ubicacionesExistentes = [] }) => {
  ...
  const renderPaso = () => {
    switch (pasoActual) {
      ...
      case 4:
        return (
          <div className="space-y-6 p-6 bg-amber-50 rounded-lg border border-amber-200">
            <div className="text-center mb-4">
  ...
  return (
    <div className="space-y-6">
      {/* Indicador de progreso mejorado */}
      <div className="flex items-center justify-between mb-6 p-4 bg-blue-50 rounded-lg">        <div className="flex items-center space-x-3">
          {[1, 2, 3, 4].map((paso) => (
      ...
      <div className="flex justify-between items-center pt-6 border-t border-gray-200">
        ...
        <div className="flex items-center space-x-2">
          <Button
            onClick={() => setPasoActual(Math.min(totalPasos, pasoActual + 1))}
            disabled={pasoActual === totalPasos}
            className="flex items-center gap-2 px-6 py-2 bg-blue-500 hover:bg-blue-600"
          >
            {pasoActual === totalPasos ? 'Finalizar' : 'Siguiente →'}
          </Button>
        </div>
      ...
      case 1:
        return (
          <div className="space-y-6">
            ...
            <div className="bg-teal-50 p-6 rounded-lg border border-teal-200 shadow-sm">
