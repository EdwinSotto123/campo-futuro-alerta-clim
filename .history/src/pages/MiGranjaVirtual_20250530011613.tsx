...
const FILAS_GRANJA = 5;
const COLUMNAS_GRANJA = 5;
              ...
              <Card className="h-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 border-4 border-indigo-300 shadow-2xl relative overflow-hidden">
                ...
                <CardContent className="h-[calc(100%-100px)] overflow-auto space-y-5 p-6 relative">
                  ...
                  <div className="space-y-5">
                    {/* Cultivos - Efecto Arcoíris */}                    <div className="bg-gradient-to-r from-emerald-400 via-green-500 to-lime-500 p-5 rounded-2xl text-white shadow-2xl">
                    ...
                    {/* Personal - Efecto Fuego */}                    <div className="bg-gradient-to-r from-orange-400 via-red-500 to-pink-600 p-5 rounded-2xl text-white shadow-2xl">
                      <div className="flex justify-between items-center">
                        <span className="flex items-center gap-3 font-black text-lg">
                          👨‍🌾 <span>Personal</span>
                        </span>
                  ...
                  {celdaSeleccionada && (
                    <div className="border-t-4 border-gradient-to-r from-indigo-500 to-purple-500 pt-6 mt-6 relative">
                      ...
                      <div className="bg-gradient-to-br from-indigo-200 via-purple-100 to-pink-200 p-6 rounded-3xl border-4 border-indigo-300 shadow-2xl relative overflow-hidden group">
                        <div className="absolute top-2 left-2 w-2 h-2 bg-pink-400 rounded-full"></div>                        {/* Removed animated decorative elements for cleaner appearance */}
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">Define la ubicación principal y áreas de cobertura del proveedor</p>            </div>

            {/* MapSelector para ubicación del proveedor */}
            <MapSelector
