...
const PerfilPage = () => {
  ...
  const [perfil, setPerfil] = useState<PerfilClimatico>({    // Información Personal
    nombre: 'Carlos',
    ...
    ubicacion: {
      latitud: -11.0059,
      longitud: -76.3717,
      direccion: 'Huancayo, Provincia de Huancayo, Junín, Perú',
      departamento: 'Junín',
      provincia: 'Huancayo',
      municipio: 'Huancayo',
      comunidad: 'San Carlos',
      altitud: 3250,
      zonaClimatica: 'Andino templado',
      precipitacionAnual: 800,
      temperaturaPromedio: 12.5,
      riesgoSequias: 'alto',
      riesgoHeladas: 'alto',
      riesgoGranizo: 'medio',
  ...
  const zonasClimaticas = [
    ...
    'Andino templado', 'Andino frío', 'Altiplano',
    'Selva Alta', 'Selva Baja', 'Yunga',
    'Tropical seco', 'Subtropical húmedo'
  ];
