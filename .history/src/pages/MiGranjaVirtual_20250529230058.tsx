                ...
                <CardContent className="h-[calc(100%-100px)] overflow-auto space-y-5 p-6 relative">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="bg-gradient-to-r from-emerald-400 via-green-500 to-lime-500 p-5 rounded-2xl text-white shadow-2xl transform hover:scale-110 hover:rotate-2 transition-all duration-500 relative overflow-hidden group neon-glow">
                      ...
                      <Progress value={(stats.cultivos / TOTAL_CELDAS) * 100} className="mt-3 h-4 bg-white/20 rounded-full overflow-hidden" />                      <div className="absolute top-2 right-2 text-2xl">✨</div>
                    </div>

                    {/* Proveedores - Efecto Océano */}
                    <div className="bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-600 p-5 rounded-2xl text-white shadow-2xl relative overflow-hidden group">
                      <div className="flex justify-between items-center relative z-10">
                        <span className="flex items-center gap-3 font-black text-lg">
                      ...
                      <Progress value={(stats.proveedores / TOTAL_CELDAS) * 100} className="mt-3 h-4 bg-white/20 rounded-full overflow-hidden" />                      <div className="absolute top-2 right-2 text-2xl">💫</div>
                    </div>

                    {/* Clientes - Efecto Galaxia */}
                    <div className="bg-gradient-to-r from-fuchsia-400 via-purple-500 to-violet-600 p-5 rounded-2xl text-white shadow-2xl relative overflow-hidden group">
                      <div className="flex justify-between items-center relative z-10">
                        <span className="flex items-center gap-3 font-black text-lg">
                          👥 <span>Clientes</span>
                        </span>
                    ...
                    <div className="bg-gradient-to-r from-yellow-400 via-amber-500 to-orange-600 p-5 rounded-2xl text-white shadow-2xl relative overflow-hidden group">
                      <div className="flex justify-between items-center relative z-10">
                        <span className="flex items-center gap-3 font-black text-lg">
                          🏭 <span>Almacenes</span>
                        </span>
                      ...
                      <Progress value={(stats.almacenes / TOTAL_CELDAS) * 100} className="mt-3 h-4 bg-white/20 rounded-full overflow-hidden" />                      <div className="absolute top-2 right-2 text-2xl">💎</div>
                    </div>

                    {/* Reservorios - Efecto Cristal */}
                    <div className="bg-gradient-to-r from-sky-400 via-cyan-500 to-blue-600 p-5 rounded-2xl text-white shadow-2xl relative overflow-hidden group">
                      <div className="flex justify-between items-center relative z-10">
                        <span className="flex items-center gap-3 font-black text-lg">
                    ...
                    <div className="bg-gradient-to-r from-gray-400 via-slate-500 to-zinc-600 p-5 rounded-2xl text-white shadow-2xl relative overflow-hidden group">
                      <div className="flex justify-between items-center relative z-10">
                        <span className="flex items-center gap-3 font-black text-lg">                          🎯 <span>Disponibles</span>
                        </span>
                        <div className="flex items-center gap-3">
                          <div className="bg-white/30 rounded-full px-4 py-2 backdrop-blur-sm">
                  ...
                  <div className="border-t-4 border-gradient-to-r from-emerald-500 to-cyan-500 pt-6 mt-6 relative">
                    ...
                    <div className="space-y-4 mt-4">
                      <Button 
                        size="lg" 
                        className="w-full justify-start text-sm bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-400 hover:to-purple-500 text-white font-bold py-3 px-4 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300 relative overflow-hidden group"
                        onClick={() => setVistaActual('estadisticas')}
                      >
