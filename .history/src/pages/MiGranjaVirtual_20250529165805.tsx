...
const customStyles = `
  @keyframes fadeInUp {
    ...
    .animate-subtle-rise {
    animation: subtle-rise 4s ease-in-out infinite;
  }

  .animate-gentle-highlight {
    animation: gentle-highlight 3s ease-in-out infinite;
  }
                ...
                <CardHeader>
                  ...
                  >
                      ...
                      return (
                        ...
                        >
                          {/* Emoji principal */}
                          <div className="text-3xl mb-2 transition-transform duration-200 group-hover:scale-110">{estilo.emoji}</div>
