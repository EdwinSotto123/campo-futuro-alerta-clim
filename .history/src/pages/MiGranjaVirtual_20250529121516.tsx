...
const MiGranjaVirtual: React.FC = () => {
  ...
  const obtenerEstiloCelda = (celda: CeldaGranja) => {
    const estilosBase = "w-full h-24 border-4 rounded-2xl transition-all duration-700 hover:scale-125 hover:rotate-6 cursor-pointer flex flex-col items-center justify-center text-center p-2 relative overflow-hidden backdrop-blur-md transform-gpu group";
    
    switch (celda.tipo) {
      case 'cultivo':
        const cultivo = celda.datos as Cultivo;
        return {
          className: `${estilosBase} bg-gradient-to-br from-lime-400 via-emerald-500 to-green-600 border-emerald-300 hover:from-lime-300 hover:via-emerald-400 hover:to-green-500 hover:shadow-2xl hover:shadow-green-400/60 animate-heartbeat neon-glow sparkle`,
          icon: '🌱',
      ...
      case 'proveedor':
        ...
        return {
          className: `${estilosBase} bg-gradient-to-br from-cyan-400 via-blue-500 to-indigo-700 border-cyan-300 hover:from-cyan-300 hover:via-blue-400 hover:to-indigo-600 hover:shadow-2xl hover:shadow-blue-500/60 animate-float neon-glow`,
          icon: '🏪',
      ...
      case 'cliente':
        ...
        return {
          className: `${estilosBase} bg-gradient-to-br from-fuchsia-400 via-purple-500 to-violet-700 border-fuchsia-300 hover:from-fuchsia-300 hover:via-purple-400 hover:to-violet-600 hover:shadow-2xl hover:shadow-purple-500/60 animate-rainbow neon-glow sparkle`,
          icon: '👥',
      ...
      case 'trabajador':
        ...
        return {
          className: `${estilosBase} bg-gradient-to-br from-amber-400 via-orange-500 to-red-600 border-amber-300 hover:from-amber-300 hover:via-orange-400 hover:to-red-500 hover:shadow-2xl hover:shadow-orange-500/60 animate-wiggle neon-glow`,
          icon: '👨‍🌾',
      ...
      case 'almacen':
        ...
        return {
          className: `${estilosBase} bg-gradient-to-br from-yellow-400 via-orange-500 to-red-700 border-yellow-300 hover:from-yellow-300 hover:via-orange-400 hover:to-red-600 hover:shadow-2xl hover:shadow-yellow-500/60 animate-glow neon-glow sparkle`,
          icon: '🏭',
      ...
      case 'reservorio':
        ...
        return {
          className: `${estilosBase} bg-gradient-to-br from-sky-400 via-cyan-500 to-blue-700 border-sky-300 hover:from-sky-300 hover:via-cyan-400 hover:to-blue-600 hover:shadow-2xl hover:shadow-cyan-500/60 animate-shimmer neon-glow`,
          icon: '💧',
      ...
      default:
        return {
          className: `${estilosBase} bg-gradient-to-br from-slate-300 via-gray-400 to-zinc-500 border-gray-300 hover:from-emerald-300 hover:via-green-400 hover:to-lime-500 hover:border-emerald-400 hover:shadow-2xl hover:shadow-emerald-400/50 glassmorphism group gradient-border`,
          icon: '➕',
          emoji: '🌍',
          texto: 'Agregar',
          subtexto: 'Click aquí'
