  ...
  const obtenerEstiloCelda = (celda: CeldaGranja) => {
    ...
    switch (celda.tipo) {
      ...
      case 'reservorio':
        ...
        return {
          className: `${estilosBase} bg-cyan-100 border-cyan-300 hover:bg-cyan-200 hover:shadow-lg animate-gentle-highlight`,
          icon: '💧',
                ...
                <CardContent className="h-[calc(100%-100px)] overflow-auto space-y-5 p-6 relative">
                  ...
                  <div className="border-t-2 border-gray-200 pt-6 mt-6">
                    ...
                    <div className="space-y-3">
                      <Button 
                        size="lg" 
                        className="w-full justify-start text-sm bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200"
                        onClick={() => setVistaActual('estadisticas')}
                      >
                      ...
                      <Button 
                        size="lg" 
                        className="w-full justify-start text-sm bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200"
                        onClick={() => {
