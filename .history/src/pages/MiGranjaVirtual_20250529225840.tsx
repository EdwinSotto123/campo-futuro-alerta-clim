                    ...
                    {granja.map((celda, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-xs text-white/95 drop-shadow-md font-bold group-hover:text-yellow-100 transition-colors duration-300">{estilo.subtexto}</div>                          {/* Múltiples indicadores para elementos ocupados */}
                          {celda.tipo !== 'vacio' && (
                            <>
