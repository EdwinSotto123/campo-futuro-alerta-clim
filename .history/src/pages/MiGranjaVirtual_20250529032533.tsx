...
const FormularioCultivo: React.FC<{ formData: any; setFormData: (data: any) => void }> = ({ formData, setFormData }) => {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Anote problemas observados, tratamientos aplicados, condiciones especiales del suelo, etc."
                rows={4}
                className="border-purple-200 focus:border-purple-400"
              />
            </div>
            ...
            {formData.tipo && (
              <div className="mt-6 p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border-l-4 border-green-400">
                <h4 className="text-md font-semibold text-green-700 mb-2 flex items-center gap-2">
                  ...
                  🤖 Evaluación Preliminar de IA
                </h4>
                <div className="space-y-2 text-sm">
                  {(() => {
                    const riesgo = evaluarRiesgoClimaticoIA(formData);
                    const mensajes = {
                      'low': '🟢 Condiciones FAVORABLES - La IA detecta bajo riesgo climático',
                      'medium': '🟡 Condiciones NORMALES - Monitoreo regular recomendado',
                      'high': '🔴 Condiciones de ALTO RIESGO - Considere medidas adicionales'
                    };
                    return (
                  ...
                  <p className="text-gray-600">
                    💡 La IA analizará automáticamente factores como tipo de cultivo, condiciones del suelo, 
                    método de riego y ubicación para generar recomendaciones personalizadas.
                  </p>
                </div>
              </div>
            )}
  ...
  return (
    <div className="space-y-6">      {/* Indicador de progreso */}
