...
const MiGranjaVirtual: React.FC = () => {
  ...
  // 🎨 FUNCIÓN PARA OBTENER EL ESTILO VISUAL DE CADA CELDA (¡MEJORADA CON COLORES VIVOS Y ANIMACIONES!)
  const obtenerEstiloCelda = (celda: CeldaGranja) => {
    const estilosBase = "w-full h-24 border-3 rounded-xl transition-all duration-500 hover:scale-110 hover:rotate-1 cursor-pointer flex flex-col items-center justify-center text-center p-2 relative overflow-hidden backdrop-blur-sm";
    
    switch (celda.tipo) {
      case 'cultivo':
        const cultivo = celda.datos as Cultivo;
        return {
          className: `${estilosBase} bg-gradient-to-br from-emerald-400 via-green-500 to-lime-600 border-emerald-300 hover:from-emerald-300 hover:via-green-400 hover:to-lime-500 hover:shadow-2xl hover:shadow-green-400/50 transform-gpu animate-pulse`,
          icon: '🌱',
      ...
      case 'proveedor':
        ...
        return {
          className: `${estilosBase} bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-700 border-blue-400 hover:from-blue-400 hover:via-indigo-500 hover:to-purple-600 hover:shadow-2xl hover:shadow-blue-500/50 transform-gpu`,
          icon: '🏪',
      ...
      case 'cliente':
        ...
        return {
          className: `${estilosBase} bg-gradient-to-br from-purple-500 via-pink-600 to-rose-700 border-purple-400 hover:from-purple-400 hover:via-pink-500 hover:to-rose-600 hover:shadow-2xl hover:shadow-purple-500/50 transform-gpu`,
          icon: '👥',
      ...
      case 'trabajador':
        ...
        return {
          className: `${estilosBase} bg-gradient-to-br from-orange-500 via-amber-600 to-yellow-700 border-orange-400 hover:from-orange-400 hover:via-amber-500 hover:to-yellow-600 hover:shadow-2xl hover:shadow-orange-500/50 transform-gpu animate-bounce`,
          icon: '👨‍🌾',
      ...
      case 'almacen':
        ...
        return {
          className: `${estilosBase} bg-gradient-to-br from-yellow-500 via-orange-600 to-red-700 border-yellow-400 hover:from-yellow-400 hover:via-orange-500 hover:to-red-600 hover:shadow-2xl hover:shadow-yellow-500/50 transform-gpu animate-pulse`,
          icon: '🏭',
      ...
      case 'reservorio':
        ...
        return {
          className: `${estilosBase} bg-gradient-to-br from-cyan-500 via-blue-600 to-indigo-700 border-cyan-400 hover:from-cyan-400 hover:via-blue-500 hover:to-indigo-600 hover:shadow-2xl hover:shadow-cyan-500/50 transform-gpu animate-pulse`,
          icon: '💧',
      ...
      default:
        return {
          className: `${estilosBase} bg-gradient-to-br from-slate-200 via-gray-300 to-stone-400 border-gray-300 hover:from-slate-100 hover:via-gray-200 hover:to-stone-300 hover:border-emerald-400 hover:shadow-2xl hover:shadow-emerald-400/30 transform-gpu group`,
          icon: '➕',
          emoji: '🌍',
          texto: 'Agregar',
          subtexto: 'Click aquí'
          ...
          <ResizablePanelGroup direction="horizontal" className="h-[600px] rounded-lg border">
            ...
            <ResizablePanel defaultSize={70} minSize={50}>
              <Card className="h-full">
                ...
                </CardHeader>                <CardContent className="h-[calc(100%-120px)] overflow-auto bg-gradient-to-br from-emerald-50 via-green-50 to-lime-50 p-4 rounded-lg">
                  {/* Grid de la granja con efectos visuales mejorados */}
                  <div 
                    className="grid gap-3 auto-rows-fr p-4 bg-white/20 backdrop-blur-sm rounded-2xl border border-white/30 shadow-2xl"
                    ...
                    {granja.map((celda, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform group-hover:translate-x-full"></div>
                          
                          {/* Emoji con efecto de flotación */}
                          <div className="text-3xl mb-1 transform group-hover:scale-125 transition-transform duration-300 drop-shadow-lg">{estilo.emoji}</div>
                          
                          {/* Texto principal con mejor contraste */}
                          <div className="text-xs font-bold text-white drop-shadow-md">{estilo.texto}</div>
                          
                          {/* Subtexto con efecto de glow */}
                          <div className="text-xs text-white/90 drop-shadow-sm font-medium">{estilo.subtexto}</div>
                          
                          {/* Indicador de punto en la esquina para elementos ocupados */}
                          {celda.tipo !== 'vacia' && (
            ...
            <ResizableHandle withHandle />            {/* Panel Derecho - Resumen y Detalles MEJORADO */}
            <ResizablePanel defaultSize={30} minSize={25}>
              <Card className="h-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 border-2 border-indigo-200 shadow-2xl">
                ...
                <CardContent className="h-[calc(100%-80px)] overflow-auto space-y-4 p-6">
                  {/* Estadísticas Rápidas con Diseño Mejorado */}
                  <div className="space-y-4">
                    {/* Cultivos */}
                    <div className="bg-gradient-to-r from-emerald-400 to-green-500 p-4 rounded-xl text-white shadow-lg transform hover:scale-105 transition-all duration-300">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="bg-white/20 rounded-full px-3 py-1">
                            <span className="font-bold text-lg">{stats.cultivos}</span>
                          </div>
                        </div>
                      </div>
                      <Progress value={(stats.cultivos / TOTAL_CELDAS) * 100} className="mt-2 h-3 bg-white/20" />
                    </div>

                    {/* Proveedores */}
                    <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-4 rounded-xl text-white shadow-lg transform hover:scale-105 transition-all duration-300">
                      <div className="flex justify-between items-center">
                        <span className="flex items-center gap-2 font-bold">
                          🏪 Proveedores
                        </span>
                        <div className="flex items-center gap-2">
                          <div className="bg-white/20 rounded-full px-3 py-1">
                            <span className="font-bold text-lg">{stats.proveedores}</span>
                          </div>
                        </div>
                      </div>
                      <Progress value={(stats.proveedores / TOTAL_CELDAS) * 100} className="mt-2 h-3 bg-white/20" />
                    </div>

                    {/* Clientes */}
                    <div className="bg-gradient-to-r from-purple-500 to-pink-600 p-4 rounded-xl text-white shadow-lg transform hover:scale-105 transition-all duration-300">
                      <div className="flex justify-between items-center">
                        <span className="flex items-center gap-2 font-bold">
                          👥 Clientes
                        </span>
                        <div className="flex items-center gap-2">
                          <div className="bg-white/20 rounded-full px-3 py-1">
                            <span className="font-bold text-lg">{stats.clientes}</span>
                          </div>
                        </div>
                      </div>
                      <Progress value={(stats.clientes / TOTAL_CELDAS) * 100} className="mt-2 h-3 bg-white/20" />
                    </div>

                    {/* Personal */}
                    <div className="bg-gradient-to-r from-orange-500 to-yellow-600 p-4 rounded-xl text-white shadow-lg transform hover:scale-105 transition-all duration-300">
                      <div className="flex justify-between items-center">
                        <span className="flex items-center gap-2 font-bold">
                          👨‍🌾 Personal
                        </span>
                        <div className="flex items-center gap-2">
                          <div className="bg-white/20 rounded-full px-3 py-1">
                            <span className="font-bold text-lg">{stats.trabajadores}</span>
                          </div>
                        </div>
                      </div>
                      <Progress value={(stats.trabajadores / TOTAL_CELDAS) * 100} className="mt-2 h-3 bg-white/20" />
                    </div>

                    {/* Almacenes */}
                    <div className="bg-gradient-to-r from-yellow-500 to-orange-600 p-4 rounded-xl text-white shadow-lg transform hover:scale-105 transition-all duration-300">
                      <div className="flex justify-between items-center">
                        <span className="flex items-center gap-2 font-bold">
                          🏭 Almacenes
                        </span>
                        <div className="flex items-center gap-2">
                          <div className="bg-white/20 rounded-full px-3 py-1">
                            <span className="font-bold text-lg">{stats.almacenes}</span>
                          </div>
                        </div>
                      </div>
                      <Progress value={(stats.almacenes / TOTAL_CELDAS) * 100} className="mt-2 h-3 bg-white/20" />
                    </div>

                    {/* Reservorios */}
                    <div className="bg-gradient-to-r from-cyan-500 to-blue-600 p-4 rounded-xl text-white shadow-lg transform hover:scale-105 transition-all duration-300">
                      <div className="flex justify-between items-center">
                        <span className="flex items-center gap-2 font-bold">
                          💧 Reservorios
                        </span>
                        <div className="flex items-center gap-2">
                          <div className="bg-white/20 rounded-full px-3 py-1">
                            <span className="font-bold text-lg">{stats.reservorios}</span>
                          </div>
                        </div>
                      </div>
                      <Progress value={(stats.reservorios / TOTAL_CELDAS) * 100} className="mt-2 h-3 bg-white/20" />
                    </div>

                    {/* Disponibles */}
                    <div className="bg-gradient-to-r from-gray-400 to-slate-500 p-4 rounded-xl text-white shadow-lg transform hover:scale-105 transition-all duration-300">
                      <div className="flex justify-between items-center">
                        <span className="flex items-center gap-2 font-bold">
                          🎯 Disponibles
                        </span>
                        <div className="flex items-center gap-2">
                          <div className="bg-white/20 rounded-full px-3 py-1">
                            <span className="font-bold text-lg">{stats.vacias}</span>
                          </div>
                        </div>
                      </div>
                      <Progress value={(stats.vacias / TOTAL_CELDAS) * 100} className="mt-2 h-3 bg-white/20" />
                    </div>
                  </div>

                  {/* Información de Celda Seleccionada con Diseño Mejorado */}
                  {celdaSeleccionada && (
                    <div className="border-t-4 border-indigo-300 pt-6 mt-6">
                      <h4 className="font-bold text-lg mb-4 text-indigo-800 flex items-center gap-2">
                        ✨ Celda Seleccionada
                      </h4>
                      <div className="bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 p-6 rounded-2xl border-2 border-indigo-200 shadow-lg transform hover:scale-105 transition-all duration-300">
                        <div className="text-center mb-4">
                          <div className="text-6xl mb-2 animate-bounce">{obtenerEstiloCelda(celdaSeleccionada).emoji}</div>
                          <div className="text-xl font-bold text-indigo-800">{obtenerEstiloCelda(celdaSeleccionada).texto}</div>
                          <div className="text-xs text-gray-500">{obtenerEstiloCelda(celdaSeleccionada).subtexto}</div>
                        </div>                        <div className="text-xs space-y-1">
                          <div><strong>Posición:</strong> Fila {celdaSeleccionada.fila + 1}, Columna {celdaSeleccionada.columna + 1}</div>
                          <div><strong>Tipo:</strong> {celdaSeleccionada.tipo}</div>
                          <div><strong>Estado:</strong> {celdaSeleccionada.datos ? 'Ocupada' : 'Disponible'}</div>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="border-t pt-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Button 
                        size="sm" 
                        variant="outline" 
                        className="w-full justify-start text-xs"                        onClick={() => {
