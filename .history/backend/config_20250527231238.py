...
class Config:
    ...
    # Available regions with agricultural profiles
    AVAILABLE_REGIONS = [
        "colombia", "méxico", "mexico", "argentina", "brasil", "brazil", 
        "chile", "peru", "perú", "ecuador", "bolivia", "venezuela",
        "paraguay", "uruguay", "guatemala", "el salvador", "honduras",
        "nicaragua", "costa rica", "panamá", "panama", "república dominicana",
        "republica dominicana", "cuba", "puerto rico", "haiti", "haití"
    ]
    ...
    def get_language_prompt(language: str) -> str:
        ...
        return Config.LANGUAGE_PROMPTS.get(language.upper(), Config.LANGUAGE_PROMPTS["ESPAÑOL"])
